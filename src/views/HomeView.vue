            ...
            <div class="bg-white border shadow p-5 text-xl text-gray-700 font-semibold">
              ...
              <div>
                <div class="flex gap-5">
                  <h1><i class='bx bxs-like text-blue-500'></i> <span class="text-gray-700">{{ like }}</span></h1>
                  <h1><i class='bx bxs-chat text-red-500'></i><span class="text-gray-700">10</span></h1>
                </div>
              </div>
            </div>
            <div class="bg-white p-1 border shadow flex flex-row flex-wrap rounded-b-xl">
